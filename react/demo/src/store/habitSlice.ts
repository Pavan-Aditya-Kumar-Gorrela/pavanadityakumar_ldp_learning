...
export const fetchHabits = createAsyncThunk("Habit/habits", async () => {
...
const habitSlice = createSlice({
    ...
    reducers: {
        ...
        removeHabit: (state, action: PayloadAction<{ hab:Habit}>) =>{
            const index = state.habits.indexOf(action.payload.hab)
